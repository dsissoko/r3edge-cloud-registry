...
public interface ServiceRegistry {
    ...
    /**
     * Résout une URL **interne** d’instance pour un service donné.
     *
     * @param serviceName nom du service
     * @return URL interne d'une instance disponible, ou {@code null}
     */
    String resolveInternalServiceUrl(String serviceName);

    /**
     * Résout une URL **externe** d’instance pour un service donné.
     *
     * @param serviceName nom du service
     * @return URL externe d'une instance disponible, ou {@code null}
     */
    String resolveExternalServiceUrl(String serviceName);

    /**
     * Résout une URL **interne** d’instance exposant une feature donnée.
     *
     * @param feature nom de la feature
     * @return URL interne d'une instance, ou {@code null}
     */
    String resolveInternalFeatureUrl(String feature);

    /**
     * Résout une URL **externe** d’instance exposant une feature donnée.
     *
     * @param feature nom de la feature
     * @return URL externe d'une instance, ou {@code null}
     */
    String resolveExternalFeatureUrl(String feature);
